...
class BranchaccountbalanceController extends Controller
{
    ...
    public function index()
    {
     ...
     if($userrole == '101')
     {      
      //  return   Userbalance::with(['branchName','branchNamefrom','ceratedUserdetails','approvedUserdetails', 'statusName'])->latest('id')
    ...
    //   ->paginate(20);
     ...
     if($userrole != '100')
     {      
        return   Branchcashstanding::with(['branchBalance'])->latest('id')
        
       //return   Userbalance::withlatest('id')
      // return   Madeexpense::latest('id')
        //->where('del', 0)
       ->paginate(20);
    }
