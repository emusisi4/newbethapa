...
class DeletecashcreditConroller extends Controller
{
...
$user->update($request->all());
    ...
    public function destroy($id)
    {
     ...
     $approvalstate = \DB::table('couttransfers')->where('id', $id )->value('status');
     $usercreates = \DB::table('couttransfers')->where('id', $id )->value('ucret');
     ...
     if($approvalstate == '1')
     {
      ...
      $amountthatwasrecieved = \DB::table('couttransfers')->where('id', $id)->value('amount');
      $newbal = $thewalletbalance+$amountthatwasrecieved;

      $transactionno = \DB::table('couttransfers')->where('id', $id)->value('transactionno');
