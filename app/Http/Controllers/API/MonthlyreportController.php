...
class MonthlyreportController extends Controller
{
    ...
    $userrole =  auth('api')->user()->type;
     ...
     $monthtoview = DB::table('monthlyreporttoviews')->where('ucret', $userid)->value('monthname');
     $yeartoview = DB::table('monthlyreporttoviews')->where('ucret', $userid)->value('yearname');
     $reporyttype = DB::table('monthlyreporttoviews')->where('ucret', $userid)->value('reporttype');




     if($reporyttype == "salesreport")
      {
