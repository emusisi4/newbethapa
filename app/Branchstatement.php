...
class Branchstatement extends Authenticatable
{
    use HasApiTokens, Notifiable;

  
    protected $fillable = [
        'branchname', 'datedone','ucret','statementtype',
        'statementstatus','transactionamount','closingbalance','yearmade'
        ,'monthmade','description'
