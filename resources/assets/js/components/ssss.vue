...
<template>
<div>
    <!-- v-if="allowedtoaccesscomponent > 0 " -->
          <div class="card" >
              <div class="card-header">
                <h3 class="card-title"><b>Expenses Report by Branch</b></h3>
                              ...
                              <td>   <template v-if="mydataObjectinfo.branch_name">	{{mydataObjectinfo.branch_name.branchname}}</template></td>
                               <td>    <template v-if="mydataObjectinfo.expense_name">	{{mydataObjectinfo.expense_name.expensename}}</template></td>
                                    ...
                                    <td> {{((mydataObjectinfo.description))}} </td>
                                       <td>Ssp {{formatPrice((mydataObjectinfo.amount))}} </td>
...
// Our method to GET results from a Laravel endpoint
      getResults(page = 1) {
                        axios.get('api/getexpensereportdetails?page=' + page)
                          .then(response => {
...
this.form.put('api/getexpensereportdetailsd/'+this.form.id)
  .then(()=> {
    // on success
   $('#addNew').modal('hide');
    swal.fire(
    ...
    if(result.value){
           ...
           checkAccess(){
               //  axios.get("api/getMakeexpense").then(({ data }) => (this.info = data));
                   ...
                   axios.get("api/getexpensereportdetails").then(({ data }) => (this.mydataObject = data));
           },
            loadDatarecords(){


                
  axios.get("api/expensereportbydatecomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
        ...
        //console.log(response.data););
            ...
            createNewrecord(){
                                ...
                                this.$Progress.start();
                                this.form.post('api/expensesreportbybranch')
                                .then(()=>{
