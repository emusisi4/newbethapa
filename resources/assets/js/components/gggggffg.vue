                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-profile-tab"
                     data-toggle="pill" href="#custom-tabs-two-profile" role="tab"
                      @click="loadSubmenus()"  aria-controls="custom-tabs-two-profile" aria-selected="false">Sales Report By Date</a>
...
<!--  -->
       ...
       <input v-model="form.actionaid" type="hidden" readonly="" name="actionaid">
             ...
             <table class="table">
                  ...
                  <tbody>
                    ...
                    <td width="5%">{{submenuinfo.datedone}}</td>
                     <td  width="20%">   <template v-if="submenuinfo.branchname_dailycodes">	{{submenuinfo.branchname_dailycodes.branchname}}</template></td>  
                    <td>
 ...
 <div class="progress" style="height: 25px; font-size: 19px;">
    <div
         ...
         role="progressbar"
         v-bind:style="{ width: Math.round(((submenuinfo.daysalesamount)/1400000)*100 )+ '%'}"
         v-bind:aria-valuenow="value"
         aria-valuemin="0"
         aria-valuemax="100"
         >  {{Math.round(((submenuinfo.daysalesamount)/1400000)*100) }} % </div>
 </div>
