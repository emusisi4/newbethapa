...
<div class="col-lg-3 col-2" >
         ...
         <div class="small-box bg-pnne">
              <div class="inner">
                <h3>Online  </h3>
<hr>
  <h6><b>  Deposits : {{formatPrice(grandtotalonlinedeposits) }} {{currencydetails}}</b> </h6>
  <h6> <b>  Withdraws : {{formatPrice(grandtotalonlinewithdraws) }} {{currencydetails}} </b>  </h6>
<hr>
           <h3>Net Balance :  {{formatPrice(grandtotalonlinedeposits-grandtotalonlinewithdraws) }} {{currencydetails}} </h3>
...
grandtotalpayoutvirtualcancelled:null,
grandtotalpayoutvirtual:null,
grandtotalpayoutsoccer:null,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////// Start of Sub menus
  ...
  loadSubmenus(){
     ...
     ////
        axios.get("api/grandtotalsales").then(({ data }) => (this.grandtotalsales = data));
...
axios.get("api/selecteddatetotalsales").then(({ data }) => (this.selecteddatetotalsales = data));
 axios.get("api/grandtotalsales").then(({ data }) => (this.grandtotalsales = data));
 axios.get("api/grandtotalonlinedeposits").then(({ data }) => (this.grandtotalonlinedeposits = data));
  axios.get("api/grandtotalpayoutsoccer").then(({ data }) => (this.grandtotalpayoutsoccer = data));
   axios.get("api/grandtotalpayoutvirtual").then(({ data }) => (this.grandtotalpayoutvirtual = data));
    axios.get("api/grandtotalpayoutvirtualcancelled").then(({ data }) => (this.grandtotalpayoutvirtualcancelled = data));
axios.get("api/grandtotalonlinewithdraws").then(({ data }) => (this.grandtotalonlinewithdraws = data));
...
this.loading = false;
    ...
    createMainmenu(){
      this.$Progress.start();
        this.form.post('api/mainmenucomponents')
        .then(()=>{
