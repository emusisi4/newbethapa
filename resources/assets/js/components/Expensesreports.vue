              ...
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    ...
                    aria-controls="custom-tabs-two-messages" aria-selected="false">Branch Monthly EXPENSES Report Detailed</a>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-settings-tab" data-toggle="pill"
                     ...
                     aria-controls="custom-tabs-two-settings" aria-selected="false">MONTHLY EXPENSES REPORT - Summary </a>
