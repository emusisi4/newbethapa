...
<!-- <div  v-if="generalcomponentaccess > 0 "> -->
            ...
            <div class="card card-primary card-outline card-tabs">
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-two-home-tab" data-toggle="pill" href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true">users</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-profile-tab"
                     data-toggle="pill" href="#custom-tabs-two-profile" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="false">SUB-MENUS</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-messages-tab" data-toggle="pill" href="#custom-tabs-two-messages" role="tab" 
                    aria-controls="custom-tabs-two-messages" aria-selected="false">VUE-COMPONENTS</a>
                  </li>
                 
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-settings-tab" data-toggle="pill"
                     href="#custom-tabs-two-settings" role="tab" aria-controls="custom-tabs-two-settings" aria-selected="false">FORM / COMPONENT FEATURES</a>
                  </li>

                   <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-three-tab" data-toggle="pill" href="#custom-tabs-two-three" role="tab" aria-controls="custom-tabs-two-three" aria-selected="false">Employee Leaves</a>
                  </li>


                    <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-four-tab" data-toggle="pill" href="#custom-tabs-two-four" role="tab" aria-controls="custom-tabs-two-four" aria-selected="false">Four</a>
                  </li>


                    <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-five-tab" data-toggle="pill" href="#custom-tabs-two-five" role="tab" aria-controls="custom-tabs-two-four" aria-selected="false">Five</a>
                  </li>


                    <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-six-tab" data-toggle="pill" href="#custom-tabs-two-six" role="tab" aria-controls="custom-tabs-two-six" aria-selected="false">Six</a>
                  </li>


                    <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-seven-tab" data-toggle="pill" href="#custom-tabs-two-seven" role="tab" aria-controls="custom-tabs-two-seven" aria-selected="false">Seven</a>
                  </li>
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                 ...
                 <div class="bethapa-table-header">
                      User Details <button type="button" class="add-newm" @click="newUsermodal" >Add New </button>
                     </div>
               ...
               <!-- <Select2 v-model="form.branch" :options= v-for="data in brancheslist" v-bind:value='data.branchno'>{{ data.branchno }} - {{ data.branchname }} /> 


<Select2 v-model="myValue" :options="myOptions" class="form-control form-control-sm" /><br>  -->
                  ...
                  <tbody>
                    <tr>
                              ...
                              <button type="button"   class="btn  bg-gradient-secondary btn-xs fas fa-edit"  @click="editUser(usersdata)">Edit</button>
                             


                            <button type="button" class="btn  bg-gradient-danger btn-xs fas fa-trash-alt" @click="deleteUser(usersdata.id)"> DEl </button>
...
<div class="modal fade" id="addnewUsermodal">
            ...
            <div  class="modal-header">
                ...
                <button  type="button" data-dismiss="modal" aria-label="Close" class="close"><span  aria-hidden="true">×</span></button></div> 
                 <form class="form-horizontal" @submit.prevent="editmode ? updateUser():createUser()"> 
                  ...
                  <div class="form-grouparranged  row">
      ...
      <has-error :form="form" field="name"></has-error>
                  ...
                  <div class="form-grouparranged  row">
                    ...
                    class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('type') }">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group">
                            ...
                            <select class='form-control' id="country" v-model='country' @change='getStates()'>
    ...
    export default {
        ...
        return {
         ...
         // accessusercoponent : null,
          myValue: '',
           myOptions: ['Option one', 'Option two', 'Option three'], // or [{id: key, text: value}, {id: key, text: value}]
          editmode: false,
          usersrecords : {},
           brancheslist:{},
            form: new Form({
...
getCountries: function(){ axios.get('/api/getCountries').then(function (response) { this.countries = response.data;}.bind(this));},

getStates: function(){axios.get('/api/getStates',{ params: {country_id: this.country } }).then(function(response){this.states = response.data;
