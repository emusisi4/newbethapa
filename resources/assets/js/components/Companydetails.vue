...
<div  v-if="generalcomponentaccessComponentfeatures > 0 "> 
 ...
 <div>
        ...
        <!-- Start of the -->
 <div class="bethapa-component-header" >COMPANY DETAILS </div>        
<div class="col-12 col-sm-12 col-lg-12">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-two-home-tab"
                     data-toggle="pill" href="#custom-tabs-two-home" role="tab" 
                      @click="loadManinmens()"
                      aria-controls="custom-tabs-two-home" aria-selected="true">CURRENCY DETAILS</a>
      ...
      <div class="tab-content" id="custom-tabs-two-tabContent">
                 ...
                 <div class="bethapa-table-header">
                    CURRENCY DETAILS <button  type="button" class="add-newm" @click="newMainmenumodal" >Add New </button>
                     </div>
       <!-- v-if="allowedtoaddmainmenu > 0" -->
              ...
              <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                       <tr v-for="mydataObjectinfo in currencydetailsrecords.data" :key="mydataObjectinfo.id">
                                                  
                    <td>{{mydataObjectinfo.id}}</td>
                    
                     <td>{{mydataObjectinfo.companyname}}</td>
                     <td>{{mydataObjectinfo.currency}}</td>
                    
                                 <td>{{mydataObjectinfo.currencysymbol}}</td> 
                          <td>     
                            <a href="#">
                               ...
                               <button type="button"  v-if="allowedtoeditmainmenu > 0"  class="btn  bg-gradient-secondary btn-xs fas fa-edit"  @click="editMainmenu(mydataObjectinfo)">Edit</button>
                              </a>
                               <a href="#">
                                     <button type="button"  v-if="allowedtodeletemainmenu > 0" class="btn  bg-gradient-danger btn-xs fas fa-trash-alt" @click="deleteMainmenu(mydataObjectinfo.id)"> Del</button></a>
                      </td>
                    </tr>
    ...
    <div class="card-footer">
                <ul class="pagination pagination-sm m-0 float-right">
                   <pagination :data="currencydetailsrecords" @pagination-change-page="paginationResultmainmemurecords"></pagination>
                </ul>
              </div>
             ...
             <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>{{submenuinfo.id}}</td>
                     ...
                     <td>{{submenuinfo.linkrouterre  }}</td>
                     ...
                     <td>{{submenuinfo.updated_at}}</td>
                          <td>     
                            <a href="#">
                               <button type="button"   class="btn  bg-gradient-secondary btn-xs fas fa-edit"  @click="editSubmenu(submenuinfo)">Edit</button>
                              </a>
                               <a href="#">
                                     <button type="button" class="btn  bg-gradient-danger btn-xs fas fa-trash-alt" @click="deleteSubmenu(submenuinfo.id)"> Del</button></a>
                      </td>
                    </tr>
...
methods:{
  ...
  paginationResultmainmemurecords(page = 1) {
                        axios.get('api/currencydetailsrecords?page=' + page)
                          .then(response => {
                            this.currencydetailsrecords = response.data;
                          });
                      },
...
paginationResultscomponentfeatures(page = 1) {
                        axios.get('api/componentfeatures?page=' + page)
                          .then(response => {
                            this.componentfeaturesrecords = response.data;
                          });
                      },
...
loadComponentfeatures(){
  ...
  editcomponentfeature(currencydetailsrecords){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(currencydetailsrecords);
$('#addnewcomponentfeaturemodal').modal('show');
            },
...
this.form.put('api/componentfeatures/'+this.form.id)
  .then(()=> {
    // on success
   $('#addnewcomponentfeaturemodal').modal('hide');
    Swal.fire(
...
if (result.isConfirmed) {
  this.form.delete('api/componentfeatures/'+id).then(()=>{
...
loadVuecomponents(){
  ...
  editvuecomponent(currencydetailsrecords){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(currencydetailsrecords);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////// Start of Sub menus
  ...
  editSubmenu(currencydetailsrecords){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(currencydetailsrecords);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// End of Submenus
  ...
  /// Main menus
  loadManinmens(){
       axios.get("api/currencydetailsrecords").then(({ data }) => (this.currencydetailsrecords = data));
       this.getRoles();
  ...
  editMainmenu(currencydetailsrecords){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(currencydetailsrecords);
$('#addnewMainmenumodal').modal('show');
    ...
    createMainmenu(){
      this.$Progress.start();
        this.form.post('api/currencydetailsrecords')
        .then(()=>{

         
    $('#addnewMainmenumodal').modal('hide');
    Fire.$emit('AfterAction');
  Toast.fire({
  icon: 'success',
  title: 'Record added successfully'
...
this.form.put('api/currencydetailsrecords/'+this.form.id)
  .then(()=> {
    // on success
   $('#addnewMainmenumodal').modal('hide');
    Swal.fire(
...
/// send request ti
if (result.isConfirmed) {
  this.form.delete('api/currencydetailsrecords/'+id).then(()=>{
