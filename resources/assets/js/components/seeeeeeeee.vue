...
<style src="node_modules/select2-bootstrap-theme/dist/select2-bootstrap.min.css"></style>
              ...
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                 ...
                 <li class="nav-item">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-six-tab" data-toggle="pill" @click="loadCompanyproducts()"
                    href="#custom-tabs-two-six" role="tab" aria-controls="custom-tabs-two-six" aria-selected="false">Company Products</a>
                  </li>


                    <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-seven-tab" 
                    data-toggle="pill" href="#custom-tabs-two-seven" 
                    role="tab" aria-controls="custom-tabs-two-seven" 
                    aria-selected="false">Branches && Products</a>
                  </li>


                    <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-two-eight-tab" data-toggle="pill" href="#custom-tabs-two-eight" role="tab" aria-controls="custom-tabs-two-eight" aria-selected="false">Eight</a>
                  </li>
...
<!-- kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk -->
  ...
  <div class="tab-pane fade" id="custom-tabs-two-six" role="tabpanel" aria-labelledby="custom-tabs-two-six-tab">
   ...
   <div class="bethapa-table-header">
                      COMPANY PRODUCTS <button  type="button" class="add-newm" @click="newCompanyproduct" >Add New </button>
                      <!-- v-if="allowedtoaddsubmenuaccess > 0" -->
                     </div>
...
<!-- Modal add menu -->
<div class="modal fade" id="addnewcompanyproductmodal">
        <div class="modal-dialog modal-dialog-top modal-lg">
        <div  class="modal-content">
            <div  class="modal-header">
                ...
                <h4  v-show="editmode" class="modal-title" >UPDATE RECORD</h4> 
                <button  type="button" data-dismiss="modal" aria-label="Close" class="close"><span  aria-hidden="true">×</span></button></div> 
                 <form class="form-horizontal" @submit.prevent="editmode ? updateUser():createNewcompanyproduct()"> 
...
paginationroleAuthorisedcomponentsfeature(page = 1) {
  ...
  loadMacines(){
   ...
   loadCompanyproducts(){
        ...
        axios.get("api/companyproducts").then(({ data }) => (this.companyproductsdatarecords = data));
        axios.get("api/generalcomponentaccessSettings").then(({ data }) => (this.generalcomponentaccessSettings = data));
        axios.get("api/usersccessSettings").then(({ data }) => (this.usersccessSettings = data));
        axios.get("api/rolesaccessSettings").then(({ data }) => (this.rolesaccessSettings = data));
        axios.get("api/submenuaccessSettings").then(({ data }) => (this.submenuaccessSettings = data));
...
newcomponentfeatureadd(){
     ...
     $('#addnewcompanyproductmodal').modal('show');
            },
              newFishmachine(){
        this.editmode = false;
        this.form.clear();
...
createNewcompanyproduct(){
      this.$Progress.start();
        this.form.post('api/companyproducts')
        .then(()=>{
